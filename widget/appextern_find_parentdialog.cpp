...
AppExternFindParentDialog::AppExternFindParentDialog(applyType type, int count, QJsonArray array, QWidget *parent)
...
void AppExternFindParentDialog::dataAnalysis(applyType type, QJsonArray array)
{
    m_name1->setText(tr("我想继续使用: "));
 ...
 * @date 2021-11-10
 */
void AppExternFindParentDialog::sendExternData(QJsonArray array)
{
